  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        <h1 className="font-headline text-2xl font-bold text-foreground/90">Welcome Back</h1>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-card/50 px-3 text-muted-foreground font-medium">Or continue with</span>
            </div>
          </div>
          ...
          <Button 
            type="button" 
            variant="outline" 
            className="w-full h-12 text-base font-semibold border-border/50 hover:border-primary/30 hover:bg-primary/5 transition-all duration-200" 
            disabled={isLoading}
